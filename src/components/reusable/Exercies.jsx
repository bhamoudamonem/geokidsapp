...
import EasyFive from "./exercies/Lesson5/Easy/Easyfive";
import MeduimN from "./exercies/Lesson5/meduim/MeduimN";
import HardN from "./exercies/Lesson5/hard/HardN";
        ...
        <View style={styles.modalContainer}>
          ...
          <View style={styles.infoContainer}>
            <Text style={styles.infoText}>
              درس: {lessonId[lessonId.length - 1]}
            </Text>
            <Text style={styles.infoText}>المستوى: {leveltoarabic(level)}</Text>
          </View>
          ...
          <View style={styles.contentContainer}>
            ...
            {lessonId === "lesson-5" && level == "EASY" ? <EasyFive /> : null}
            {lessonId === "lesson-5" && level === "MEDIUM" ? <MeduimN /> : null}
            {lessonId === "lesson-5" && level === "HARD" ? <HardN /> : null}
          </View>
        </View>
      </View>
    </Modal>
