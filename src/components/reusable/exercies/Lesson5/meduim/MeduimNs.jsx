...
const allCountries = {
  تونس: "المنتجات الصناعية",
  الجزائر: "المواد المنجمية والطاقية",
  ليبيا: "مواد المنجمية والطاقية + المنتجات الصناعية",
  المغرب: "كلّ المنتجات",
};
const MeduimNs = () => {
  ...
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.title}>اربط كل بلد بأهم صادراته.</Text>
